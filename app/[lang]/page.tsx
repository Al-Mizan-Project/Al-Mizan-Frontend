...
export default async function Page({
  ...
  const spaces = [
  {
    title: dict.space_service_contractant || "Service contractant",
    desc:  "Gestion des projets, planification et lancement des appels d'offres.",
    icon: faBuilding,
    color: "border-[#005c6e]"
  },
  {
    title: dict.space_operateur_economique || "Opérateur économique",
    desc:  "Consultation des marchés, dépôt des offres et suivi des contrats.",
    icon: faUserTie,
    color: "border-[#1a4331]"
  },
  {
    title: dict.space_commission_validation || "Commission de validation",
    desc:  "Examen des dossiers, contrôle de conformité et validation externe.",
    icon: faGears,
    color: "border-[#d4af37]"
  },
  {
    title: dict.space_tutelle || "Tutelle",
    desc:  "Supervision administrative et suivi des orientations stratégiques.",
    icon: faUserShield,
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Grille de cartes adaptée (4 colonnes sur large desktop) */}
        ...
        {/* Bouton Global de Redirection */}
        <div className="flex justify-center">
          <Link 
            href={`/${lang}/register/organisation`}
            className="group bg-[#005c6e] text-white px-10 py-4 rounded-sm font-bold text-sm uppercase tracking-widest flex items-center gap-4 hover:bg-gray transition-all shadow-lg hover:-translate-y-1"
          >
            <span>{dict.btn_declare_org || "Déclarer une nouvelle organisation"}</span>
          </Link>
        </div>
