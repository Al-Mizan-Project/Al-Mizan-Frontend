...
export default function ServiceContractantShell({
  children,
}: {
  ...
  const navItems = [
    ...
    { id: 'organisation', label: 'Organisation', href: `/${lang}/dashboard/contractant/organisation/permissions` },
  ];
          ...
          <header className={styles.topbar}>
            ...
            <div className={styles.topActions}>
              <div className={styles.orgBadge}>
                <div className={styles.orgBadgeValue}>Direction des marchés — Wilaya d’Alger</div>
              </div>
              ...
              <div className={styles.profile}>
                ...
                <div>
                  <strong>Admin service contractant</strong>
                  <small>sc.admin@wilaya.dz</small>
                </div>
              </div>
            </div>
          </header>
