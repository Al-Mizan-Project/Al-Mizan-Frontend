...
import type { COPEOPage } from '@/app/[lang]/copeo/page';

const navItems: { id: COPEOPage; label: string; icon: ReactElement }[] = [
  {
    id: 'vue-personnelle',
...
interface Props {
  activePage: COPEOPage;
  setActivePage: (id: COPEOPage) => void;
  memberName?: string;
  memberEmail?: string;
  roleLabel?: 'Président de séance' | 'Secrétaire' | 'Membre';
}

export default function COPEOSidebar({ activePage, setActivePage, memberName = 'Membre COPEO', memberEmail = 'membre@copeo.dz', roleLabel = 'Membre' }: Props) {
      ...
      <div className="px-4 py-4 border-t border-gray-100">
        <div className="flex items-center gap-3 px-2">
          ...
          <div className="overflow-hidden">
            ...
            {/* Role label is display-only — no permission difference between members */}
            <p className="text-xs text-gray-400 truncate">{roleLabel} · COPEO</p>
          </div>
        </div>
      </div>
    </aside>
